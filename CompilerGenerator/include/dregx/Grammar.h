...
::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::ProductionRule> group_opt_pad_LEFT_CURLY_BRACKET_square_opt_pad_RIGHT_CURLY_BRACKET_STAR;
::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::ProductionRule> group_opt_pad_LEFT_CURLY_BRACKET_square_opt_pad_RIGHT_CURLY_BRACKET_PLUS;
::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::ProductionRule> group_opt_pad_LEFT_CURLY_BRACKET_square_opt_pad_RIGHT_CURLY_BRACKET_extension_modifier;
::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::ProductionRule> group_opt_pad_LEFT_CURLY_BRACKET_square_opt_pad_RIGHT_CURLY_BRACKET;
...
::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::ProductionRule> or_concat_group_opt_pad_OR_group;
::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::ProductionRule> or_concat_group_opt_pad_OR_square;
::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::ProductionRule> or_concat_square_opt_pad_OR_group;
::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::ProductionRule> or_concat_square_opt_pad_OR_square;
