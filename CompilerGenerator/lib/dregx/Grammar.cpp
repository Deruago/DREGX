...
or_concat.Set(::deamer::language::type::definition::object::main::NonTerminal("or_concat", { or_concat_word_opt_pad_OR_deamerreserved_arrow__word__.Pointer() } , ::deamer::language::type::definition::object::main::NonTerminalAbstraction::Standard , false));
deamerreserved_arrow__word__.Set(::deamer::language::type::definition::object::main::NonTerminal("deamerreserved_arrow__word__", { deamerreserved_arrow__word___word_deamerreserved_star__opt_pad__OR__word__.Pointer() } , ::deamer::language::type::definition::object::main::NonTerminalAbstraction::Standard , true));
deamerreserved_star__opt_pad__OR__word__.Set(::deamer::language::type::definition::object::main::NonTerminal("deamerreserved_star__opt_pad__OR__word__", { deamerreserved_star__opt_pad__OR__word___opt_pad_OR_word_deamerreserved_star__opt_pad__OR__word__.Pointer(),deamerreserved_star__opt_pad__OR__word___EMPTY.Pointer() } , ::deamer::language::type::definition::object::main::NonTerminalAbstraction::Standard , true));
...
deamerreserved_arrow__word___word_deamerreserved_star__opt_pad__OR__word__.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->word.Pointer(),Language->deamerreserved_star__opt_pad__OR__word__.Pointer() }));
deamerreserved_star__opt_pad__OR__word___opt_pad_OR_word_deamerreserved_star__opt_pad__OR__word__.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->opt_pad.Pointer(),Language->OR.Pointer(),Language->word.Pointer(),Language->deamerreserved_star__opt_pad__OR__word__.Pointer() }));
deamerreserved_star__opt_pad__OR__word___EMPTY.Set(::deamer::language::type::definition::object::main::ProductionRule());
or_concat_word_opt_pad_OR_deamerreserved_arrow__word__.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->word.Pointer(),Language->opt_pad.Pointer(),Language->OR.Pointer(),Language->deamerreserved_arrow__word__.Pointer() }));
...
AddObject(or_concat);
AddObject(deamerreserved_arrow__word__);
AddObject(deamerreserved_star__opt_pad__OR__word__);
AddObject(square);
AddObject(capture);
...
AddObject(deamerreserved_arrow__word___word_deamerreserved_star__opt_pad__OR__word__);
AddObject(deamerreserved_star__opt_pad__OR__word___opt_pad_OR_word_deamerreserved_star__opt_pad__OR__word__);
AddObject(deamerreserved_star__opt_pad__OR__word___EMPTY);
AddObject(or_concat_word_opt_pad_OR_deamerreserved_arrow__word__);
