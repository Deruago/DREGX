...
#include "dregx/Ast/Relation/NodeEnumToText.h"
#include <fstream>
#include <iostream>
#include <sstream>
#include <vector>
...
int main(int argc, const char* argv[])
{
	...
	for (const auto& filename : filenames)
	{
		...
		{
			std::cout << "\tTokenName: " << dregx::ast::relation::ConvertEnumToText(static_cast<dregx::ast::Type>(token->Type)) << "\n";
